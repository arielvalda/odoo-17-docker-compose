...
git clone --depth=1 https://github.com/arielvalda/odoo-17-docker-compose $DESTINATION
...
echo 'Started Odoo @ http://localhost:'$PORT' | Master Password: test17 | Live chat port: '$CHAT
